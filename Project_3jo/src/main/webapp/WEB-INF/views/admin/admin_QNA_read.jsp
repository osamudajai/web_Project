	...
	<div style="display:flex; padding:30px; justify-content:center;">
        ...
        <div class="div2_q">
            ...
            <div class="right">
                ...
                <form method="post" action="admin_henji">
                <input type="hidden" name="q_num" value="${qna.q_num}">
                <input type="hidden" name="list_cg" value="${qna.list_cg}">
                <input type="hidden" name="po_id" value="${qna.po_id}">
                <input type="hidden" name="q_title" value="${qna.q_title}">
                <input type="hidden" name="q_date" value="${qna.q_date}">
                <input type="hidden" name="q_content" value="${qna.q_content}">
                <input type="hidden" name="q_originalfile" value="${qna.q_originalfile}">
                <input type="hidden" name="q_savedfile" value="${qna.q_savedfile}">
                답변 내용
                <input type="text" name="a_content">
